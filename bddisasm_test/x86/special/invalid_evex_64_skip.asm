    ...
    db 0x62, 0xf2, 0xfd, 0x08, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    
    ; EVEX.aaa == 0 for an instruction which has mandatory masking
    db 0x62, 0xf2, 0xfd, 0x28, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    
    ; EVEX.aaa == 0 for an instruction which has mandatory masking
    db 0x62, 0xf2, 0xfd, 0x48, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    
    ; EVEX.b (broadcast) enabled for an instruction which does not support broadcast (mod: mem)
    db 0x62, 0xf2, 0xfd, 0x19, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    
    ; EVEX.b (broadcast) enabled for an instruction which does not support broadcast (mod: mem)
    db 0x62, 0xf2, 0xfd, 0x39, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    
    ; EVEX.b (broadcast) enabled for an instruction which does not support broadcast (mod: mem)
    db 0x62, 0xf2, 0xfd, 0x59, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    
    ; EVEX.z enabled for an instruction which does not support zeroing
    db 0x62, 0xf2, 0xfd, 0x89, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    
    ; EVEX.z enabled for an instruction which does not support zeroing
    db 0x62, 0xf2, 0xfd, 0xa9, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    
    ; EVEX.z enabled for an instruction which does not support zeroing
    db 0x62, 0xf2, 0xfd, 0xc9, 0x92, 0x54, 0x43, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90
    ...
    ; LE: EVEX.U with mem form -> U is ~X4, used for index extension. Encoding valid. EVEX.U handled only if APX enabled.
