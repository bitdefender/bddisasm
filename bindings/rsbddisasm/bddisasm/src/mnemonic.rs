...
impl TryFrom<ffi::ND_INS_CLASS> for Mnemonic {
    ...
    fn try_from(value: ffi::ND_INS_CLASS) -> Result<Self, Self::Error> {
        match value {
            ...
            ffi::_ND_INS_CLASS::ND_INS_IBHF => Ok(Mnemonic::IBHF),
            ...
            ffi::_ND_INS_CLASS::ND_INS_TCVTROWPS2BF16H => Ok(Mnemonic::TCVTROWPS2BF16H),
            ffi::_ND_INS_CLASS::ND_INS_TCVTROWPS2BF16L => Ok(Mnemonic::TCVTROWPS2BF16L),
